...
sample_path = "/Users/Natsume/Downloads/data_for_all/dogscats/sample/train"
batches = get_batches_from_dir(directory = sample_path,
							   image_data_generator=func_imageDataGenerator(),
							   target_size=(224, 224),
							   color_mode = "rgb", # add up to (224,224,3)
							#    classes=["dogs", "cats"],
							   class_mode="binary", # for only 2 classes
							   batch_size=32,
							   shuffle=True,
							   seed=123,
